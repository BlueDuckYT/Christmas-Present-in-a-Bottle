...
public class Registry {
    ...
    public static final RegistryObject<Block> BOTTLE_LAUNCHER = BLOCKS.register("bottle_launcher", () -> new BottleLauncherBlock(Block.Properties.from(JellyfishingBlocks.SCRAP_METAL.get()).notSolid()));
